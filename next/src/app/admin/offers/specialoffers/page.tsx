...
export default function BannersPage() {
  ...
  const fetchBanners = useCallback(async () => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_PATH}/admin/special-offers`, {
        headers: {
  ...
  const handleDelete = async (_id: string) => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_PATH}/admin/special-offers?id=${_id}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
