...
const services = [
  ...
  { title: '🚖 Airport Transfers', details: ['Private cabs for airport pickup & drop', 'Intercity & intracity cab booking services', 'Transparent pricing with no hidden charges'] },
